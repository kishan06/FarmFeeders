class RecurringOrderDetailModel {
  int? status;
  bool? success;
  Data? data;
  String? message;

  RecurringOrderDetailModel(
      {this.status, this.success, this.data, this.message});

  RecurringOrderDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (orderHistory != null) {
      data['order_history'] = orderHistory!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
