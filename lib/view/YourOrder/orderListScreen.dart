                            ...
                            ? ongoingOrderListModel.data!.isEmpty
                                ...
                                : SizedBox(
                                    ...
                                    child: ListView.builder(
                                        itemCount:
                                            ongoingOrderListModel.data!.length,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    ongoingOrderListModel
                                                                            ...
                                                                            .any((item) =>
                                                                                ...
                                                                                4)
                                                                        ? status()
                                                                        : (ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 1) ||
                                                                                ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 3))
                                                                            ? CircleAvatar(
                                                                    ...
                                                                    ongoingOrderListModel
                                                                            ...
                                                                            .any((item) =>
                                                                                ...
                                                                                7)
                                                                        ? status()
                                                                        : (ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 5) ||
                                                                                ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 6))
                                                                            ? CircleAvatar(
                                                                                backgroundColor: AppColors.buttoncolour,
                                                                                radius: 11.w,
                                                                                child: CircleAvatar(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        sizedBoxWidth(
                                                                            6.w),
                                                                        Text(
                                                                          Utils.convertUtcToCustomFormat(ongoingOrderListModel
                                                                              .data![index]
                                                                              .orderDate!),
                                                                          style: TextStyle(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        color: (ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 3) &&
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        style: TextStyle(
                                                                            fontSize: 14
                                                                                .sp,
                                                                            color: ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 4)
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          style:
                                                                            ...
                                                                            fontSize:
                                                                                14.sp,
                                                                            color: ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 5)
                                                                                ? const Color(0XFF0E5F02)
                                                                                : const Color(0XFF4D4D4D),
                                                                            fontFamily:
                                                                                "Poppins",
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        borderRadius:
                                                                            BorderRadius.circular(25.h),
                                                                        color: !((ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 5) || ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid == 6)) &&
                                                                                ongoingOrderListModel.data![index].orderStatus!.any((item) => item.deliveryStatusXid != 7))
                                                                            ? Colors.transparent
                                                                            : const Color(0XFFF1F1F1),
                                                                      ),
                                                                      child:
