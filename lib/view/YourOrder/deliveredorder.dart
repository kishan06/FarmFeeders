                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            sizedBoxHeight(8.h),
                                            Text(
                                              "Contact sales person to reorder \nyour purchase",
                                              style: TextStyle(
                                                  fontSize: 14.sp,
                                                  color:
                                                      const Color(0XFF141414),
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            sizedBoxHeight(8.h),
                                            Text(
                                              "Ordered ${Utils.convertUtcToCustomFormat(orderDetailsModel.data!.orderDetails!.orderDate!)}",
                                              style: TextStyle(
                                                  fontSize: 14.sp,
                                                  color:
                                                      const Color(0XFF141414),
